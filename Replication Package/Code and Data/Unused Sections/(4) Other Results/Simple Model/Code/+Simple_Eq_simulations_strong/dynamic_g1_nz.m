...
% Returns the coordinates of non-zero elements in the Jacobian, in column-major order, for each lead/lag (only for endogenous)
  ...
  nzij_pred(5,1)=3; nzij_pred(5,2)=3;
  nzij_pred(6,1)=4; nzij_pred(6,2)=3;
  nzij_pred(7,1)=8; nzij_pred(7,2)=3;
  nzij_pred(8,1)=10; nzij_pred(8,2)=3;
  nzij_pred(9,1)=4; nzij_pred(9,2)=4;
  nzij_pred(10,1)=1; nzij_pred(10,2)=5;
  nzij_pred(11,1)=7; nzij_pred(11,2)=5;
  nzij_pred(12,1)=5; nzij_pred(12,2)=6;
  nzij_pred(13,1)=6; nzij_pred(13,2)=7;
  nzij_pred(14,1)=3; nzij_pred(14,2)=10;
  nzij_pred(15,1)=4; nzij_pred(15,2)=10;
