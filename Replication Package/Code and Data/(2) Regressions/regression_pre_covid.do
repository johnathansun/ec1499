...
* Output Location
cd "..\Replication Package\Code and Data\(2) Regressions\Output Data (Restricted Sample)\"
...
keep period gcpi vu gw magpty grpe grpf cf1 cf10 shortage diffcpicf CPIENGSL CPIUFDSL
...
putexcel set "eq_coefficients_restricted", replace sheet("gw")
putexcel B1 = "beta"
matrix b = e(b)'
...
list aa1 bb1 cc1 dd1 if period == tq(2019:1)  
	...
	* P-value (sum)
putexcel set "summary_stats_restricted", replace sheet("gw")
...
gen gcpi_residuals =  gcpi - gcpif
	...
	* Save coefficients in excel format 
putexcel set "eq_coefficients_restricted", modify sheet("gcpi", replace)
putexcel B1 = "beta"
putexcel B1 = "beta"
matrix b = e(b)'
putexcel A2 = matrix(b), rownames nformat(number_d7)
...
list period aa2 bb2 cc2 dd2 ee2 if period == tq(2019:1)
	...
	* P-value (sum)
putexcel set "summary_stats_restricted", modify sheet("gcpi", replace)
putexcel B1 = "sum of coefficients"
putexcel B1 = "sum of coefficients"
putexcel C1 = "p value (sum)"
putexcel D1 = "p value (joint)"
...
gen cf1_residuals = cf1-cf1f
	...
	* Save coefficients in excel format
putexcel set "eq_coefficients_restricted", modify sheet("cf1", replace)
putexcel B1 = "beta"
putexcel B1 = "beta"
matrix b = e(b)'
putexcel A2 = matrix(b), rownames nformat(number_d7)
...
list period aa3 bb3 cc3 if period==tq(2019:1) 
	* P-value (sum)
putexcel set "summary_stats_restricted", modify sheet("cf1", replace)
putexcel B1 = "sum of coefficients"
putexcel B1 = "sum of coefficients"
putexcel C1 = "p value (sum)"
putexcel D1 = "p value (joint)"
...
gen cf10_residuals = cf10f-cf10 
	* Save coefficients in excel format
putexcel set "eq_coefficients_restricted", modify sheet("cf10", replace)
putexcel B1 = "beta"
putexcel B1 = "beta"
matrix b = e(b)'
putexcel A2 = matrix(b), rownames nformat(number_d7)
...
list period aa4 bb4 if period == tq(2019:1) 
	* P-value (sum)
putexcel set "summary_stats_restricted", modify sheet("cf10", replace)
putexcel B1 = "sum of coefficients"
putexcel B1 = "sum of coefficients"
putexcel C1 = "p value (sum)"
putexcel D1 = "p value (joint)"
...
export excel eq_simulations_data_restricted, firstrow(variables) replace
