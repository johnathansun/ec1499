...
if option.estimate.iter > 0
    for i = 1:option.estimate.iter
        ...
        global counts
        counts = 0;
        [param, fval, exitflag, output] = fminsearch('solve_step1', param_init, options, N, T, Psi, Sig, I_pi, I_gdp, I_y1, I_yspr, I_pdm, I_divgrm, divgrpos, ...
...
filepath = '../tables/TableLambda_StepOne.tex';
steptag = 'One';
Write_Ls;
