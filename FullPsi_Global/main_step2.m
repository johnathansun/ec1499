...
if option.estimate.iter > 0
    ...
    for i = 1:option.estimate.iter
        ...
        global counts
        counts = 0;
        [param, fval, exitflag, output] = fminsearch('solve_step2', param_init, options, param0, N, T, Psi, Sig, I_pi, I_gdp, I_y1, I_yspr, I_pdm, I_divgrm, divgrpos, I_pi_g, I_gdp_g, I_equityreg, ...
